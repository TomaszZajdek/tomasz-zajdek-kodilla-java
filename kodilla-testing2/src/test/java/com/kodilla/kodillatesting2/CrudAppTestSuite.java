...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://tomaszzajdek.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("username")).sendKeys("tomaszzajdek@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login-submit"));
        el.submit();

        Thread.sleep(2000);

        driverTrello.findElement(By.id("password")).sendKeys("Halabarda");
        el.submit();
